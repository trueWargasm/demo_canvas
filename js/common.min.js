$(function () {		
    ...
    $("#canvas").droppable({
        ...
        drop: function (event, ui) {
			...
			var json_rect_green = jQuery.extend(true, {}, json_rect);
			json_rect_green.fill = "#27ae60";

			var json_rect_red = jQuery.extend(true, {}, json_rect);
			json_rect_red.fill = "#c0392b";
			json_rect_red.costValue = 1000;
			
			var json_rect_yellow = jQuery.extend(true, {}, json_rect);
			json_rect_yellow.fill = "#f39c12";
			json_rect_yellow.costValue = 1000;

			var json_rect_blue = jQuery.extend(true, {}, json_rect);
			json_rect_blue.fill = "#2980b9";
			json_rect_blue.costValue = 500;

			var json_rect_orange = jQuery.extend(true, {}, json_rect);
			json_rect_orange.fill = "#d35400";
			json_rect_orange.costValue = 500;
